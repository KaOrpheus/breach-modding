...
-- Command line was: LastManStanding.luac 

module("LastManStanding", package.seeall)
require("Gametype")
...
l_0_0.InitGameData = function(l_2_0)
  ...
  if DGDataNodeManager.EnumAllNodesOfType("DGDataNodeTeamBase") then
    ...
    ps:SetRespawnEnabled(false)
     -- Warning: missing end command somewhere! Added here
  end
end

l_0_0.Initialize = function(l_3_0)
  l_3_0.name = "LastManStanding"
end
...
l_0_0.PostStartGame = function(l_6_0)
  ...
  l_6_0:AddEndCondition(new("DeathEndCondition", "BlackOps", function()
    gameInfo.topTeam = "OpFor"
   end))
  l_6_0:AddEndCondition(new("DeathEndCondition", "OpFor", function()
    gameInfo.topTeam = "BlackOps"
   end))
  local l_6_3, l_6_4 = l_6_0:AddScoringCondition, l_6_0
  local l_6_5 = new
  local l_6_6 = "DeathScoringCondition"
  local l_6_7 = "LMS Kill Count"
  l_6_5 = l_6_5(l_6_6, l_6_7, {scoreAllDeaths = true})
  do
